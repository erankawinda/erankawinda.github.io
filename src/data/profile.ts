export const profile = {
  ...
  timeline: [
    ...
    },
    {
      ...
      title: "Bachelor of Science Honours in Physics",
      description: "University of Colombo."
    },
    {
      date: "Teaching",
      title: "Teaching Assistant / Temporary Teaching Assistant",
      description: "University of Colombo."
    },
    {
      date: "Research background",
      title: "Drought prediction in Sri Lanka",
      description: "Deep learning approach using multivariate RNN and stacked LSTM methods."
    },
    {
  ...
  values: [
    {
      ...
      description: "Clear inputs, assumptions, baselines, and limitations before conclusions."
    },
    {
      title: "Careful evaluation",
      description: "Evidence that can be inspected, repeated, or questioned by someone else."
    },
    {
      title: "Respect for uncertainty",
      description: "Data systems for physical and social contexts need constraints, context, and modest claims."
    }
  ]
};
